 ...
 */
YUI.add('addon-ac-poc', function(Y, NAME) {

    function POCAddon() {
        POCAddon.superclass.constructor.apply(this, arguments);
    }
    POCAddon.NS = 'poc';

    Y.extend(POCAddon, Y.Plugin.Base, {
    ...
    Y.mojito.addons.ac.poc = POCAddon;
