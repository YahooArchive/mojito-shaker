            ...
            try {
                typeTask.task(resource, typeTask.options, function (taskError) {
                    if (taskError) {
                        ...
                        logger.error('Task', errorMessage);
                    }
                    errorMessage = typeTask.options.critical && taskError ? errorMessage : null;
            ...
            try {
                locationModule.store(resource, function (locationError, resourceLocation) {
                    if (locationError) {
                        ...
                        logger.error('Location', locationError);
                    }
                    errorMessage = locations[location].critical && locationError ? errorMessage : null;
