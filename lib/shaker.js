...
Shaker.prototype = {
    ...
    run: function (callback) {
        var self = this,
            ...
            shakerConfig = this._core.getMergedShakerConfigByContext('shared', masterContext),
            shakerMeta = this._core.run();
    ...
    processMojitCSS: function (cssResources, shakerOptions, callback) {
        ...
        queue.task(shakerOptions.task || Shaker.DEFAULT_TASK,
                {resources: resourceList, optionsclear: shakerOptions.taskConfig});
